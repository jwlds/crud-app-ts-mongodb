...
export default class ChalkLog {
    public static log = (args: any) => this.info(args);
    public static info = (args: any) => console.log(chalk.white(`[${new Date().toLocaleString()}] [INFO]`), typeof args === 'string' ? chalk.whiteBright(args) : args);
